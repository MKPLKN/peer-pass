export default function Footer () {
  ...
  return (
    <footer className='w-full border-t border-gray-100 py-6 sm:py-10'>
      <div className='mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 px-6 sm:flex-row lg:px-8'>
        <p className='text-sm leading-7 text-gray-400'>🍐 You can kill a revolutionary but you can never kill the revolution 🍐</p>
